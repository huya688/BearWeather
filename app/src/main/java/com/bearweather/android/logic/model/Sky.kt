package com.bearweather.android.logic.model

import com.bearweather.android.R
...
private val sky = mapOf(
    ...
    "THUNDER_SHOWER" to Sky("雷阵雨",R.drawable.ic_thunder_shower,R.drawable.bg_snow),
    "SLEET" to Sky("雨夹雪",R.drawable.ic_sleet,R.drawable.bg_rain),
    "LIGHT_SNOW" to  Sky("小雪",R.drawable.ic_light_snow,R.drawable.bg_snow),
    "MODERATE_SNOW" to Sky("中",R.drawable.ic_moderate_snow,R.drawable.bg_snow),
    "HEAVY_SNOW" to Sky("da",R.drawable.ic_heavy_snow,R.drawable.bg_snow),
    "STORM_SNOW" to Sky("bao",R.drawable.ic_heavy_snow,R.drawable.bg_snow),
